...
```
![这是图片](/img/xiaohei1.png "luoxiaohei")      //![图片alt](图片链接 "图片title")
```
效果如下：
![这是图片](/img/xiaohei1.png "luoxiaohei")

### 链接图片
给图片增加链接，请将图像的Markdown 括在方括号中，然后将链接添加在圆括号中。
```
[![这是图片](/img/xiaohei1.png "luoxiaohei")](https://markdown.com.cn)     //[![图片alt](图片链接 "图片title")](链接)
```
效果如下：
[![这是图片](/img/xiaohei1.png "luoxiaohei")](https://markdown.com.cn)
...
//内联标签<span>、<cite>、<del> 、<a> 或 <img>，当你需要更改元素的属性时（例如为文本指定颜色或更改图像的宽度），使用 HTML 标签更方便些。
```
渲染效果如下:   
This **word** is bold. This <em>**word**</em> is italic.
